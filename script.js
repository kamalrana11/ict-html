...
// =============================================================================
        ...
        function changeSize() {
            ...
            // Generate random size between 20px and 35px
            var randomSize = Math.floor(Math.random() * 18) + 20;
            
            // Change the font size
            element.style.fontSize = randomSize + '1px';
            
            console.log('Font size changed to:', randomSize + '1px');
        }
